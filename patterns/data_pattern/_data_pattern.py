...
pattern = {
    ...
    'vacancy': {
        ...
        'mex': ("ФИО", "my name", " готовим IT-специалистов", "ответы с собеседований",
                ...
                "[Пп]роизводства одежды", "[Пп]реподаватель английского языка", "[Пп]роизводства одежды", "[Пп]реподаватель английского языка",
                "[Вв]одитель погрузчика", "[Вв]одитель-международник", "сопровождение грузоперевозки", "[Пп]ретензионн[ойая]{2} [Рр]абот[ае]",
                "[Бб]ухгелтер-[Сс]таж[её]р", "[Чч]лен [Бб]ригады", "[Пп]овар", "[Рр]и[еэ]лтор", "[Мм]енеджер по продаж[еам}{1,2} франшиз",
                "[Сс]таж[ёе]р в отдел мерчендайзинг", "[Пп]родюсер", "[Лл]ичный [Пп]омо[шщ]ник"
    ),
        'mex2': (),
        'mincl': (),
    },
